...
TO submit: Please rename this file LASTNAME_ProblemSet1 and upload to the assignments folder on Canvas before class on W 1/24

I. Ice sheets
Have a look at the following data, and read it into R 
Either use fread() in data.table to read it from the web, or read.csv() if you download the data. Consider using the skip argument to skip down to the data.
...
Have a look at the following data, and read it into R
Either use fread() in data.table to read it from the web, or read.csv() if you download the data. 
