...
# Q4) What is the percentage of each species in each taxa?


# Q5) How many specimens of each sex are there for each year?


# Q6) What are the minimum, maximum and average weight for each species of Rodent?


# Q7) What is the average hindfoot length for male and female rodent of each species? Is there a Male / Female difference?


# Q8) What is the average weight of each rodent species over the course of the years? Is there any noticeable trend for any of the species?
